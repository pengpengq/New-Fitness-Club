...
- (void)buildFooterView {
    ...
    self.skipButton = [[UIButton alloc] initWithFrame:CGRectMake((self.scrollView.frame.size.width -80)/2, self.pageControl.frame.origin.y+20, 80, self.pageControl.frame.size.height)];
